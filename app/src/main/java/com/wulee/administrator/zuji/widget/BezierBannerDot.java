...
/**
 * Created by wulee on 2017/10/13 14:42
 */
...
public class BezierBannerDot extends View implements ViewPager.OnPageChangeListener {
    ...
    public BezierBannerDot(Context context,  AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BezierBannerDot(Context context,  AttributeSet attrs, int defStyleAttr) {
