package com.wulee.administrator.zuji.chatui.ui.fragment;
...
import com.wulee.administrator.zuji.chatui.adapter.EmotionGridViewAdapter;
import com.wulee.administrator.zuji.chatui.adapter.EmotionPagerAdapter;
import com.wulee.administrator.zuji.chatui.base.BaseFragment;
import com.wulee.administrator.zuji.chatui.util.EmotionUtils;
...
import com.wulee.administrator.zuji.chatui.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    @InjectView(R.id.fragment_chat_vp)
    ViewPager fragmentChatVp;
    @InjectView(R.id.fragment_chat_group)
    ...
    private void initEmotion() {
        // 获取屏幕宽度
        int screenWidth = UIUtils.getScreenWidthAndHeight(getContext())[0];
        // item的间距
